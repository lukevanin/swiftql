//
//  ContextualBindingReference.swift
//  SwiftQL
//
//  The contextual binding reference and the request-facade errors around it.
//
//  Renamed from `SQLInvocationBindings.swift` (issue #555): SwiftQLCore has a
//  file of that name holding an entirely disjoint set of types, and two files
//  one name apart with nothing in common is a navigation trap -- open the wrong
//  one and every symbol you were looking for is missing.
//
