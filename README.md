...
`1.9.0` is the latest published package. The examples above use APIs retained
...
- **[Query plans and index advice](https://lukevanin.github.io/swiftql/documentation/swiftql/queryplanadvice/).**
  ...
  re-planning the query, and arrives with the plan before and after.
  `swiftql-index-advisor` turns the verified recommendations into a checked-in
  SQL file. It is advice throughout: nothing it reports can fail a build.
