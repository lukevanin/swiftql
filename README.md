...
complete SQLite grammar coverage. The canonical inventory records 109 features:
101 supported, 1 partial, 2 capability-gated, 1 intentionally unsupported, and
4 unimplemented. Of its 158 evidence records, 98 exercise real SQLite and
...
`1.4.2` is the latest published package. The examples above use APIs retained
