...
- Read [the changelog](CHANGELOG.md) before choosing a package requirement.
  `1.4.3` is the latest published package. Pin a source revision only when
...
- Treat the versioned [inventory](Tests/SwiftQLSQLiteConformanceFixtures/SQLiteConformanceInventory.json) as
  ...
  to interpret it. It records 110 feature records: 103 supported, 0 partial,
...
- Of the 162 evidence records, 100 exercise real SQLite against one captured
