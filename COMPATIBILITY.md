...
The v1.3 inventory contains 108 feature records and 152 evidence records. Its
...
Of those 152 evidence records, 95 exercise real SQLite and
cite one captured environment, SQLite 3.51.0. An inventory entry is counted in
the 100 supported features only when it links to successful preparation by a
