...
The v1.3 inventory contains 104 feature records and 133 evidence records. Its
...
Of those 133 evidence records, 85 exercise real SQLite and
cite one captured environment, SQLite 3.51.0. An inventory entry is counted in
the 95 supported features only when it links to successful preparation by a
