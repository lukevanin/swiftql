...
The v1.3 inventory contains 102 feature records and 121 evidence records. Its
...
Of those 121 evidence records, 79 exercise real SQLite and
cite one captured environment, SQLite 3.51.0. An inventory entry is counted in
the 92 supported features only when it links to successful preparation by a
