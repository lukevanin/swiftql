...
final class SQLSkillDocumentationTests: XCTestCase {
    ...
    func testSkillUsesCurrentCodexMetadataAndBoundedInstructions() throws {
        ...
        for required in [
            ...
            "1.5.6 is the latest published package, adding nullable-column assignment in `Setting` closures on top of v1.5.5 async live-query streams, `@Observable` query wrappers, and lazy result sets, v1.5.4 method-style scalar functions and observers, v1.5.3 contextual codec presets and `@SQLCodec`, v1.5.2 build-time query validation, and v1.5.1 declared-query macros (`@SQLQuery`/`@SQLQueries`) and typed transaction scopes",
