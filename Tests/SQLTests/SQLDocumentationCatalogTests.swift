    ...
    func testV13PublicDocumentsShareReleaseAndBoundaryContract() throws {
        ...
        let requiredPhrasesByPath = [
            "README.md": [
                ...
                "`1.4.1` is the latest published package",
            ],
            "COMPATIBILITY.md": [
            ...
            "Sources/SwiftQL/SwiftQL.docc/SwiftQL.md": [
                ...
                "Version 1.4.1 is the latest published package",
            ],
            "Sources/SwiftQL/SwiftQL.docc/GettingStarted.md": [
                "Version 1.4.1 is the published package",
        ...
        XCTAssertEqual(firstReleaseHeading, "## [1.4.1] - 2026-07-22")
    }
